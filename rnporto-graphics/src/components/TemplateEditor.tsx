    ...
    <div className="island-shell flex flex-col gap-4 rounded-2xl p-5">
      <div className="flex items-baseline justify-between gap-4">
        ...
        <button
          type="button"
          onClick={onReset}
          className="shrink-0 whitespace-nowrap rounded-full border border-[var(--rnp-chip-line)] bg-[var(--rnp-chip-bg)] px-3 py-1 text-xs font-semibold text-[var(--rnp-fg)] transition hover:-translate-y-0.5"
        >
          Reset
        </button>
      </div>
